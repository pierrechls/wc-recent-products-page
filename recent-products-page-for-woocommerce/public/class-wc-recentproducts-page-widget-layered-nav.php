 ...
 * @extends  WC_Widget
 */
class WC_RecentProducts_Page_Widget_Layered_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'woocommerce_recentproducts_page_layered_nav';
		$this->widget_name        = __( 'WooCommerce Recent Products Page Layered Nav', 'wc_recentproducts_page' );
		parent::__construct();
	}
	...
	protected function get_page_base_url( $taxonomy ) {
		...
		global $wp_query;
		$recentproducts_page = (int) Woocommerce_recentproducts_page_Public::get_main_wpml_id(wc_get_page_id( 'recentproducts' ));

		if ( defined( 'SHOP_IS_ON_FRONT' ) ) {
			$link = home_url();
		} elseif ($wp_query->is_recent_products_page) {
			$link =  get_page_link($recentproducts_page);
	...
	protected function get_filtered_term_product_counts( $term_ids, $taxonomy, $query_type ) {
		...
		$query['where']   = "
			...
			AND {$wpdb->posts}.ID IN ( $product_ids_recent_products )
